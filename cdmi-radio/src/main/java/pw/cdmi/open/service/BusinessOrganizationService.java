...
public interface BusinessOrganizationService {
     ...
     */
    public PageView findDepartmentListPage(Department queryObject, int paageNo, int pageSize);
    ...
    public List<Map<String, Object>> findEmployeeByCondition(String code, String name, String telephone, String deptId);
