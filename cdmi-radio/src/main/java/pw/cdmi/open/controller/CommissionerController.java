...
public class CommissionerController {
    ...
    @ResponseBody
    public List<Commissioner> findCommissionerList(String commissionerName) {
    ...
    @ResponseBody
    public JSONArray findAllCommissioner() {
        List<Commissioner> list = organizationService.findAllCommissioner();
