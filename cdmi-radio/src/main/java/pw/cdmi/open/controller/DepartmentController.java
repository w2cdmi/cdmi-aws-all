...
public class DepartmentController {
    ...
    public JSONArray findDepartmentList(String name) {
        ...
        List<Department> list = organizationService.findDepartmentList(queryObject);
    ...
    public JSONArray findFirstList() {
        ...
        for (Department dept : list) {
            ...
            List<Department> chilren = organizationService.findDepartmentList(queryObject);
    ...
    public List<Department> findAllDeparment() {
        List<Department> list = organizationService.findAllDepartment();
        return list;
    }
    ...
    public boolean findDeptName(String id, String deptName) {
        boolean bool = true;
        List<Department> deptanyList = organizationService.findAllDepartment();
