...
public class CompanyController {
    ...
    public JSONObject findCompanyList(@ModelAttribute Company comp, Integer page, Integer rows) {
        ...
        PageView pageView = organizationService.findCompanyList(comp, page, rows);
        @SuppressWarnings("unchecked")
        List<Company> list = pageView.getList();
    ...
    @ResponseBody
    public List<Company> findCompanyListByParentId(String parentId) {
    ...
    public JSONArray findSubCompanyList(String keyword) {
        ...
        List<Company> list = organizationService.findSubCompanyList(comp);
        JSONArray array = new JSONArray();
        for (Company company : list) {
            JSONObject json = new JSONObject();
            json.put("id", company.getId());
    ...
    public JSONArray findSubCompanyAndOfficeList() {
        ...
        List<Company> companyList = organizationService.findSubCompanyList(comp);
        List<Office> officeList = organizationService.findAllOffice();
    ...
    public JSONArray findParentCompany() {
        List<Company> list = organizationService.findParentCompany();
        JSONArray array = new JSONArray();
        for (Company company : list) {
            JSONObject json = new JSONObject();
            json.put("id", company.getId());
    ...
    public JSONArray findOffice(String keyword) {
        List<Office> list = organizationService.findOfficeByKeyword(keyword);
        JSONArray array = new JSONArray();
    ...
    @ResponseBody
    public JSONArray findAllOffice() {
        List<Office> list = organizationService.findAllOffice();
        JSONArray array = new JSONArray();
        for (Office office : list) {
            JSONObject json = new JSONObject();
            json.put("id", office.getId());
