...
import pw.cdmi.open.model.UserOnlineStatus;
...
@Entity
@Data
@Table(name = "p_application_user")
//@NamedQueries({
//        @NamedQuery(name = "SiteUser.deleteByAccount", query = "delete from SiteUser where accountId = ?1 and appId= ?2"),
//        @NamedQuery(name = "SiteUser.deleteByEmployee", query = "delete from SiteUser where accountId = ?1 ") })
