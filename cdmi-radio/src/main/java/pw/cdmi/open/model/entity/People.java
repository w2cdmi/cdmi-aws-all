...
public class People {
    ...
    private Integer cityId = -1;						// 对应的城市ID

    private Integer provinceId = -1;					// 对应的省份ID

    private Integer countryId = -1;						// 对应的国家ID
    ...
    /***** 居民当前居住信息 *********/
    private Integer liveCityId = -1;				// 当前居住城市

    private Integer liveDistrictId = -1;			// 当前居住的区县
