package pw.cdmi.msm.geo.service.impl;
...
import pw.cdmi.msm.geo.repositories.CityRepository;
...
public class GeoServiceImpl implements GeoService {
    ...
    public Iterable<Province> listProvinces(String domain) {
        ...
        if (country_id == null) {
            throw new AWSClientException(ClientError.NOT_GET_DATA, ClientReason.NotFoundCountryByDomain);
        }
...
//        StringBuffer hql = new StringBuffer();
    ...
    public Iterable<Province> listProvinceByCountryName(String countryName) {
        return provinceDaoImpl.findByCountryName(countryName);
//        Integer country_id = countryDaoImpl.findIdByName(countryName);
//        if(country_id == null){
//            throw new AWSClientException(ClientError.InvalidParameter);
//        }
//        return provinceDaoImpl.findByCountryId(country_id);
    }
}
