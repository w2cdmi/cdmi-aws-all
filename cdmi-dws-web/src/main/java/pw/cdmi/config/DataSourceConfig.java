...
public class DataSourceConfig {
    ...
    private DataSource buildDataSource() {
        ...
        TableRule orderTableRule = TableRule.builder("t_praise")
                .actualTables(Arrays.asList("t_praise"))
        ...
        ShardingRule shardingRule = ShardingRule.builder()
                ...
                .databaseShardingStrategy(new DatabaseShardingStrategy("id", new NoneDatabaseShardingAlgorithm()))
                .tableShardingStrategy(new TableShardingStrategy("id", new NoneTableShardingAlgorithm())).build();
    ...
    private  DruidDataSource   createDataSource(){
        ...
        List<String> stringArraysList = new ArrayList<String>();
        stringArraysList.add(connectionInitSqls);
        result.setConnectionInitSqls(stringArraysList);
        return result;
    }
