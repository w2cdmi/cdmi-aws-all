...
function getImgSrc(file) {
    //目录
    if (file.type < 1) {
        return "/disk/images/icon/folder-icon.png";
    }
    ...
    if (index != -1) {
        ...
        if (fileType == "txt" || fileType == "pdf") {
            ...
            return "/disk/images/icon/file-mp3.png";
        }
    }

    return "/disk/images/icon/file-undefined.png";
}
