...
public class PermissionServiceImpl implements PermissionService {
	...
	public void updateSiteRole(String appId, SiteRole siteRole) {
		...
		SiteRole role = daoImpl.findOne(siteRole.getId());
	...
	public SiteMenu getSiteMenuById(String id) {
		...
		try {
			siteMenu = menuRepository.findOne(id);
		} catch (Exception e) {
			log.error(e.getMessage());
			e.printStackTrace();
			throw new AWSServiceException(SystemReason.SQLError);
	...
	public DataAccess getDataAccessById(String id) {
		...
		try {
			dataAccess = dataAccessRepository.findOne(id);
		} catch (Exception e) {
			log.error(e.getMessage());
			e.printStackTrace();
			throw new AWSServiceException(SystemReason.SQLError);
	...
	public SiteUserRole getSiteUserPermissionById(String id) {
		...
		try {
			sup = userRoleRepository.findOne(id);
		} catch (Exception e) {
			log.error(e.getMessage());
			e.printStackTrace();
			throw new AWSServiceException(SystemReason.SQLError);
	...
	public void deleteSiteMenuByMenuId(String menuId) {
		try {
			SiteMenu siteMenu = menuRepository.findOne(menuId);
			if (null != siteMenu) {
	...
	public SiteMenuAcl getSiteMenuAclById(String id) {
		...
		try {
			siteMenuAcl = menuAclRepository.findOne(id);
		} catch (Exception e) {
			log.error(e.getMessage());
			e.printStackTrace();
			throw new AWSServiceException(SystemReason.SQLError);
	...
	public void deleteRoleAndDataAccessByRoleId(String roleId) {
		try {
			roleAndDataAccessRepository.delete(roleId);
		} catch (Exception e) {
			log.error(e.getMessage());
			e.printStackTrace();
			throw new AWSServiceException(SystemReason.SQLError);
	...
	public RoleAndDataAccess getRoleAndDataAccessById(String id) {
		...
		try {
			rada = roleAndDataAccessRepository.findOne(id);
		} catch (Exception e) {
			log.error(e.getMessage());
			e.printStackTrace();
			throw new AWSServiceException(SystemReason.SQLError);
